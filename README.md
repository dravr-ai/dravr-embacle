...
```toml
[dependencies]
embacle = { version = "0.31", features = ["http-api"] }
```
...
```toml
[dependencies]
embacle = { version = "0.31", features = ["agui"] }
```
...
```toml
[dependencies]
embacle = { version = "0.31", features = ["copilot-headless"] }
```
...
```toml
[dependencies]
embacle = { version = "0.31", features = ["copilot-sdk"] }
```
